...
export default function CreateProfile() {
    ...
    const validatePreferences = () => {
        let checkname,checkgender,checklevel,checkgame,checkage,checkwith, checkphone = true;
        let res = true;
        if(name === ""){
            res = checkname = false;
        ...
        <>
            ...
            <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    {current == 0 &&
                        <CreateAccount setEmail={setEmail} setPassword={setPassword} preferences={preferences}/>
                    }
                    ...
                    {current == 2 &&
                        <>
                            <Preferences setGame={setGame} setAge={setAge} setGender={setGender} setName={setName} setPhone={setPhone} setLevel={setLevel} setWith={setWith} preferences={preferences}/>
                        </>
                    }
